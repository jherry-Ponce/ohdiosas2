...
class EditProduct extends Component
{
    ...
    public function mount(Product $product){
        ...
        $this->product->SKU=$product->id.Str::limit($product->name, 3);
        $this->product->save(); 
        
        $this->categories = Category::all();
        
        /* realizando las relacioness en el metodo mount se genera un objeto con tdas las relaciones señaladas */
