...
<body>
    <div class="ticket centrado">
        <h1>OH Diosas Swimwear</h1>
        <h2>Ticket de venta #000{{$venta->id}}</h2>
        <h2>{{$venta->created_at}}</h2>
        <?php
        ...
        <table>
            ...
            <tbody>
                ...
                ?>
                    <tr>
                        <td class="cantidad"><?php echo number_format($producto->qty, 2) ?></td>
                        <td class="producto"><?php echo $producto->name ?></td>
                        <td class="precio">$<?php echo number_format($producto->subtotal, 2) ?></td>
                    </tr>
                <?php } ?>
            </tbody>
            <tr>
