<x-app-layout>
    ...
    <div class="container py-12">
        ...
        <section class="grid grid-cols-2 md:grid-cols-5 gap-4 md:gap-6 text-white">
            <a href="{{ route('orders.index') . "?status=1" }}" class="bg-red-500 bg-opacity-75 rounded-lg px-4 pt-4 pb-2 md:px-12 md:pt-8 md:pb-4">
            ...
            <a href="{{ route('orders.index') . "?status=2" }}" class="bg-gray-500 bg-opacity-75 rounded-lg px-4 pt-4 pb-2 md:px-12 md:pt-8 md:pb-4">
                <p class="text-center text-2xl">
                    {{$recibido}}
                </p>
            ...
            <a href="{{ route('orders.index') . "?status=3" }}" class="bg-yellow-600 bg-opacity-75 rounded-lg px-4 pt-4 pb-2 md:px-12 md:pt-8 md:pb-4">
                <p class="text-center text-2xl">
                    {{$enviado}}
                </p>
            ...
            <a href="{{ route('orders.index') . "?status=4" }}" class="bg-pink-600 bg-opacity-75 rounded-lg px-4 pt-4 pb-2 md:px-12 md:pt-8 md:pb-4">
                <p class="text-center text-2xl">
                    {{$entregado}}
                </p>
            ...
            <a href="{{ route('orders.index') . "?status=5" }}" class="bg-green-500 bg-opacity-75 rounded-lg px-4 pt-4 pb-2 md:px-12 md:pt-8 md:pb-4">
                <p class="text-center text-2xl">
                    {{$anulado}}
                </p>
