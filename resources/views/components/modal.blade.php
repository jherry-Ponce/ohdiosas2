            ...
            <div class="inline-block align-bottom bg-white rounded-lg text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-lg sm:w-full" role="dialog" aria-modal="true" aria-labelledby="modal-headline">    
                    ...
                    <div class="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                        ...
                        <div>
                            ...
                            <x-jet-input type="file"  id="seleccionArchivos" accept="imagen/*"  wire:model="editImagen" />
                        ...
                        <div class="mt-4">
                             ...
                             @if ($editImagen)
                                <img  class="  w-full h-96  {{--object-cover --}} object-scale-down  object-center" src="{{$editImagen->temporaryUrl()}}" >
                            @else
                                <img  class="  w-full h-96  {{--object-cover --}} object-scale-down  object-center" src="/storage/{{$imagen}} " >
                             @endif
