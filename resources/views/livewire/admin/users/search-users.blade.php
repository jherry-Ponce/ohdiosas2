          ...
          <tbody class="block md:table-row-group border">
              @foreach ($rol as $rols)     
                      <tr class=" border border-grey-500 md:border-none block md:table-row">
                          ...
                          <td class="p-2 text-left block  md:table-cell"><span class="inline-block w-1/3 md:hidden font-bold">Id</span> {{$rols->id}} </td>
                          <td class="p-2 text-left block  md:table-cell"><span class="inline-block w-1/3 md:hidden font-bold">Usuario</span>{{$rols->name}} </td>
                          <td class="p-2 text-left block  md:table-cell"><span class="inline-block w-1/3 md:hidden font-bold">Email</span>{{$rols->email}} </td>
