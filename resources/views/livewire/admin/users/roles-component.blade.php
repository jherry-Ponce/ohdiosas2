<div class=" mt-16">
    <div class="flex  pl-4 py-2 items-center shadow-xl ">
        <h2 class="text-gray-500 font-serif text-xl font-semibold  my-3 ">Roles</h2>
                    ...
                    <tbody class="block md:table-row-group border">
                        @foreach ($rol as $rols)     
                                <tr class=" border border-grey-500 md:border-none block md:table-row">
                                    ...
                                    <td class="p-2 text-left block md:text-center md:table-cell"><span class="inline-block w-1/3 md:hidden font-bold">Rol</span>{{$rols->name}} </td>
