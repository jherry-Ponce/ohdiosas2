    ...
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12 text-gray-700">
        ...
        <div class="bg-white shadow-xl rounded-lg p-6">
            ...
            <div class="grid grid-cols-2 gap-6 mb-4">
                ...
                <div>
                    ...
                    <x-jet-input wire:model="product.priceV" type="number" class="w-full" step=".01" />
                    <x-jet-input-error for="product.priceV" />
                </div>
            </div>
        ...
        @if ($this->subcategory)
            ...
            @if ($this->subcategory->size)
                ...
                @livewire('admin.colores.size-product', ['product' => $product], key('size-product-' . $product->id))

            @elseif($this->subcategory->color)

                @livewire('admin.colores.color-product', ['product' => $product], key('color-product-' . $product->id))
