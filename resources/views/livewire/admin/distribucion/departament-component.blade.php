                        ...
                        <tr>
                            ...
                            <td class="py-2">
                                <div class="flex divide-x divide-gray-300 font-semibold">
                                    <a class="pr-2 hover:text-blue-600 cursor-pointer text-indigo-600 font-bold" wire:click="edit({{$department}})"><i class="far fa-edit"></i></a>
                                    <a class="pl-2 hover:text-red-600 cursor-pointer text-red-500 font-extrabold" wire:click="$emit('deleteDepartment', {{$department->id}})"><i class="far fa-trash-alt"></i></a>
                                </div>
                            </td>
                        </tr>
                    @endforeach
